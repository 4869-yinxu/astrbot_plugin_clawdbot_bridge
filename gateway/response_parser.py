...
class ResponseParser:
    ...
    @staticmethod
    def extract_text_from_output(output: List[Dict[str, Any]]) -> Optional[str]:
        """从 output 数组中提取文本内容
    ...
    @staticmethod
    def _extract_text_from_item(item: Any) -> Optional[str]:
        """从单个 output 项中提取文本"""
    ...
    @staticmethod
    def parse_json_response(result: Dict[str, Any]) -> Optional[str]:
        """解析非流式 JSON 响应
